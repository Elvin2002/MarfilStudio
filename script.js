...
a.async=1;a.src=g;if(EcwidObj._isInteractiveEnabled() && m != null && m.parentNode != null)m.parentNode.insertBefore(a,m);else var h=100,k=setInterval(function(){ m = s.getElementsByTagName(o)[0]; if((/loaded|complete/.test(s.readyState)||0==h--) && m != null && m.parentNode != null)m.parentNode.insertBefore(a,m),clearInterval(k)},100)})(window,document,"script","https://ecomm.events/i.js","eca");
